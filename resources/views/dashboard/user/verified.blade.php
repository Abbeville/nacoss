                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('download.image', $user->matric) }}"><img class="rounded-circle" src="{{ asset('uploads/'.$user->avatar) }}" width="60px" /></a></td>
                                    <td>{{ $user->fullName() }}</td>
                                    <td>{{ $user->matric }}</td>
                                    ...
                                    <td>
                                        @if($user->print_status)
                                            <button type="button" class="btn btn-md btn-info"> Printed</button>
                                        @else
                                        <a href="{{ route('verify.member', $user->matric) }}" class="btn btn-md btn-info">Mark as Printed</a></td>
                                        @endif
                                </tr>
                                @endforeach
                            </tbody>
